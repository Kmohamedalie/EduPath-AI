...
const App: React.FC = () => {
  ...
  const [activeModal, setActiveModal] = useState<'docs' | 'standards' | 'terms' | 'privacy' | 'support' | 'signin' | 'profile' | null>(null);
            ...
            <div className="max-h-[70vh] overflow-y-auto pr-2 custom-scrollbar">
              ...
              {activeModal === 'standards' && (
                <div className="space-y-8 text-slate-600 dark:text-slate-400">
                  ...
                  <p className="text-[10px] font-bold uppercase text-blue-600 dark:text-blue-400">Real-time sync with latest 2024/2025 market trends.</p>
                </div>
              )}
              ...
              {activeModal === 'support' && (
                <div className="space-y-6 text-slate-600 dark:text-slate-400">
                  <div className="p-6 bg-slate-50 dark:bg-slate-800/50 rounded-3xl border border-slate-100 dark:border-slate-800 text-center">
                    ...
                    <p className="text-sm mb-6">Our research lab is available for institutional support and custom roadmap inquiries.</p>
                    <div className="flex flex-col gap-4">
                      ...
                      <p className="text-[10px] uppercase font-bold tracking-widest opacity-50">Avg response time: 24-48 Business Hours</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              {activeModal === 'terms' && (
                <div className="space-y-6 text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                  <section>
                    <h4 className="font-black text-slate-900 dark:text-white uppercase mb-2">1. Usage Agreement</h4>
                    <p>By using EduPath AI, you acknowledge that all generated curricula are synthesized by AI models and should be verified by a qualified academic or career advisor before major commitments.</p>
                  </section>
                  <section>
                    <h4 className="font-black text-slate-900 dark:text-white uppercase mb-2">2. No Guarantees</h4>
                    <p>EduPath AI does not guarantee employment, academic credit, or certification success. The platform provides architectural guidance based on public standards and industry trends.</p>
                  </section>
                  <section>
                    <h4 className="font-black text-slate-900 dark:text-white uppercase mb-2">3. Intellectual Property</h4>
                    <p>Roadmaps generated are for personal use. Commercial redistribution of the underlying "EduPath Synthesis Methodology" is prohibited without institutional licensing.</p>
                  </section>
                </div>
              )}
              ...
              {activeModal === 'privacy' && (
                <div className="space-y-6 text-xs text-slate-600 dark:text-slate-400 leading-relaxed">
                  <section>
                    <h4 className="font-black text-slate-900 dark:text-white uppercase mb-2">Data Privacy Policy</h4>
                    <p>EduPath AI prioritizes user privacy. We primarily utilize browser LocalStorage to store your preferences, skill assessments, and saved roadmaps locally on your device.</p>
                  </section>
                  <section>
                    <h4 className="font-black text-slate-900 dark:text-white uppercase mb-2">Email Sync</h4>
                    <p>Your email is used solely as a unique identifier for session synchronization. We do not sell your contact data to third-party advertisers or recruitment agencies.</p>
                  </section>
                  <section>
                    <h4 className="font-black text-slate-900 dark:text-white uppercase mb-2">AI Processing</h4>
                    <p>Input queries and assessments are processed by the Gemini API. These inputs are used in a transient manner to generate your personalized results.</p>
                  </section>
                </div>
              )}
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm font-bold text-slate-500 dark:text-slate-500">
                ...
                <li><button onClick={() => setActiveModal('privacy')} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Privacy Policy</button></li>
              </ul>
            </div>
          </div>
